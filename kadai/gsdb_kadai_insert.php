...
//３．データ登録SQL作成
$stmt = $pdo->prepare("INSERT INTO gs_gsdb_table(school_num, picture, name, age, about_work, info, presen, select_course, datetime )VALUES(:school_num, :picture, :name, :age, :about_work, :info, :presen, :select_course, sysdate())");
